...
var questions = [
  ...
  {
    question:
      "Udo has a grain of salt. There are many wolves in a hectare.  Is rose the color of a prodigy?",
    choices: [
      {
        choice: "Truffles",
        status: "true"
  ...
  {
    question:
      "Human Centipedes are most commonly used for this type of degenerative tissue behavior.",
    choices: [
      {
  ...
  {
    question:
      "Peanut butter and waffled french fries, sometimes, are referred to this type of oil change",
    choices: [
      {
